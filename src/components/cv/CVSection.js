...
const BodyText = styled.p` font-size: 23px; font-weight: 100; line-height: 35px; max-width: 900px; @media (max-width: 680px) { font-size: 18px; line-height: 30px; } }`;
const Title = styled.h1`line-height: 50px; padding: 0; margin: 0 0 2rem; color: #cd3873; color: ${props => (props.headingColor ? `#cd3873` : `#d02e77`)}; width: 100%; }`;
