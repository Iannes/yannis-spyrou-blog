...
Apart from testing our API through the AppSync dashboard, we can also test it locally!
...
If everything went well, you have successfully
provisioned the remote servers and hopefully were able 
